# Hunting Club Demo Deployment

The hunting dog club platform demo is located in `/projects/hunting-website/`.
...
The portfolio showcase page at `projects.srng.no/hunting-website` describes the project and links to the live demo at `hunting-dog-portal.srng.no`.
